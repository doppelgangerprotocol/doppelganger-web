...
def create_session():
    ...
    # Return first 40 values of the embedding vector as a preview.
    # The full vector stays in Redis — this slice is for educational display only.
    vector_preview = [round(v, 6) for v in embedding[:40]]
